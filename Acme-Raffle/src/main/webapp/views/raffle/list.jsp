...
<acme:list entityUrl="{prizes:prize/list.do}" requestURI="${requestURI}"
	...
	hidden_fields="raffle,codes,user,taxonomy,manager,participations,bills,comments"
	image_fields="logo" variable="e" pagesize="6">

	

	<security:authorize access="hasRole('USER')">
		<td><jstl:if
				test="${today.before(e.deadline)&& today.after(e.publicationTime)&& !raffleInteger.contains(e.id)}">
