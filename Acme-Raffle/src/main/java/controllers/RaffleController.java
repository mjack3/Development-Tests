...
public class RaffleController {
	...
	public ModelAndView list() {
		...
		List<Raffle> raffleBanned = raffleService.raffleManagerIsDebtor();
		List<Integer> raffleInteger = new ArrayList<Integer>();

		for (Raffle r : raffleBanned) {
			raffleInteger.add(r.getId());
		}

		result.addObject("raffleInteger", raffleInteger);
