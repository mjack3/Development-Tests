...
public class AdministratorService {
	...
	public Manager bannedManager(final Manager user) {
		Assert.notNull(user);
		Assert.isTrue(this.managerService.exists(user.getId()));
	...
	public void DisbannedManager(final Manager user) {
	...
	public List<Object> dashboard() {
		...
		//2.0
		res.add(this.administratorRepository.minAvgMaxBillunpaid());
		res.add(this.administratorRepository.minAvgMaxBillpaid());
		res.add(this.administratorRepository.minAvgMaxBillPerManager());
		res.add(this.administratorRepository.managersUnpaid());
		res.add(this.administratorRepository.ratioDebtors());
		res.add(this.administratorRepository.minAvgMaxSpecialitiesAuditor());
		res.add(this.administratorRepository.ratioEndAuditor());
