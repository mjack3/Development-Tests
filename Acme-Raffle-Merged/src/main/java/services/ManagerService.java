...
public class ManagerService {
	...
	public Manager save(final Manager manager) {
		...
		if (this.exists(manager.getId())) {
			...
			m.setCreditCard(manager.getCreditCard());
			m.setIsDebtor(manager.getIsDebtor());
	...
	public List<Manager> isDebtors() {
		return this.managerRepository.isDebtors();
	}
